...
public class StageScreen extends Stage {
  private static final String LV1 = "level/Lv1.txt";
  private static final String LV2 = "level/Lv2.txt";
  private static final String LV3 = "level/Lv3.txt";
  ...
  public int lv = 0;
  private final Group groupNoActnoBang;
  private final Group groupNoActs;
  private final Group groupActs;
  private float Xbomber, Ybomber;
  private final ArrayList<Actor> noActNoBangs = new ArrayList<>();
  private final ArrayList<Actor> noActs = new ArrayList<>();
  private final ArrayList<Actor> acts = new ArrayList<>();
  ...
  public void insertFromFile(String fileName) throws IOException {
    ...
    while ((c = reader.read()) != -1) {
      ...
      if (Character.toString((char) c).equals(" ")
          || (!Character.toString((char) c).equals("#")
              && !Character.toString((char) c).equals("x")
              && !Character.toString((char) c).equals("\r"))) {
  ...
  public boolean CheckInPortal() {
      return Bomber.nextLevel;
  }

  public boolean CheckAllEnemyDeath() {
      return balloons.size() == 0 && oneals.size() == 0 && dolls.size() == 0;
  }
  ...
  public boolean changeOfLevelUp() {
    /*if (CheckInPortal(x,y)) {
      ...
      return bomber.getX() == 200 && CheckAllEnemyDeath();
  }
  ...
  /**
   * mảng 4 phần tử gạch, tường xung quanh quả bom. [0]:up,[1]:down,[2]:right,[3]:left;
   *
   * @param x, y.
